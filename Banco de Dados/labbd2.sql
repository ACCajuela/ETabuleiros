...
-- Copiando estrutura do banco de dados para labbd2
CREATE DATABASE IF NOT EXISTS `labbd2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `labbd2`;

-- Copiando estrutura para tabela labbd2.avaliacoes_produtos
CREATE TABLE IF NOT EXISTS `avaliacoes_produtos` (
  `avaliacao_id` int NOT NULL AUTO_INCREMENT,
  `ava_prod_id` int NOT NULL,
  `ava_user_id` int NOT NULL,
  ...
  KEY `prod_id` (`ava_prod_id`) USING BTREE,
  KEY `user_id` (`ava_user_id`) USING BTREE,
  CONSTRAINT `avaliacoes_produtos_ibfk_1` FOREIGN KEY (`ava_prod_id`) REFERENCES `produtos` (`prod_id`),
  CONSTRAINT `avaliacoes_produtos_ibfk_2` FOREIGN KEY (`ava_user_id`) REFERENCES `usuarios` (`user_id`),
  CONSTRAINT `avaliacoes_produtos_chk_1` CHECK (((`nota` >= 1) and (`nota` <= 5)))
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Copiando dados para a tabela labbd2.avaliacoes_produtos: ~0 rows (aproximadamente)
DELETE FROM `avaliacoes_produtos`;
INSERT INTO `avaliacoes_produtos` (`avaliacao_id`, `ava_prod_id`, `ava_user_id`, `nota`, `comentario`, `data_avaliacao`) VALUES
	(1, 1, 1, 5, 'Catan é incrível! Aprendi a jogar rápido e é muito divertido.', '2025-03-12 23:50:22'),
	(2, 2, 2, 4, 'Carcassonne é ótimo, mas as regras podem ser um pouco confusas no início.', '2025-03-12 23:50:22'),
	(3, 3, 3, 5, 'Pandemic é desafiador e muito envolvente. Adoro jogar com amigos.', '2025-03-12 23:50:22'),
	(4, 4, 4, 5, 'Ticket to Ride é perfeito para jogar em família. Recomendo!', '2025-03-12 23:50:22'),
	(5, 5, 5, 4, '7 Wonders é complexo, mas muito recompensador quando você aprende.', '2025-03-12 23:50:22'),
	(6, 6, 6, 5, 'Dixit é ótimo para jogar em festas. Todo mundo se diverte!', '2025-03-12 23:50:22'),
	(7, 7, 7, 4, 'Splendor é simples, mas muito estratégico. Adoro!', '2025-03-12 23:50:22'),
	(8, 8, 8, 5, 'Azul é lindo e muito bem feito. Um dos meus favoritos.', '2025-03-12 23:50:22'),
	(9, 9, 9, 5, 'Codenames é ótimo para jogar em grupos grandes. Muito engraçado!', '2025-03-12 23:50:22'),
	(10, 10, 10, 5, 'Wingspan é lindo e muito educativo. Adoro os pássaros!', '2025-03-12 23:50:22'),
	(11, 11, 11, 4, 'Gloomhaven é incrível, mas exige muito tempo e dedicação.', '2025-03-12 23:50:22'),
	(12, 12, 12, 5, 'Terraforming Mars é um jogo complexo e muito recompensador.', '2025-03-12 23:50:22'),
	(13, 13, 13, 4, 'Scythe tem uma mecânica única e é muito envolvente.', '2025-03-12 23:50:22'),
	(14, 14, 1, 5, 'Gizmos é divertido e fácil de aprender. Ótimo para iniciantes.', '2025-03-12 23:50:22'),
	(15, 15, 2, 4, 'Root é um jogo assimétrico muito interessante.', '2025-03-12 23:50:22'),
	(16, 16, 3, 5, 'Everdell é lindo e muito bem feito. Adoro o tema!', '2025-03-12 23:50:22'),
	(17, 17, 4, 4, 'Wingspan: Oceania é uma ótima expansão para o jogo base.', '2025-03-12 23:50:22'),
	(18, 18, 5, 5, 'Catan: Extensão 5-6 Jogadores é essencial para quem gosta do jogo.', '2025-03-12 23:50:22'),
	(19, 19, 6, 5, 'Pandemic: Legado é uma experiência única. Recomendo!', '2025-03-12 23:50:22'),
	(20, 20, 7, 4, 'Codenames: Pictures é uma ótima variação do jogo original.', '2025-03-12 23:50:22');

-- Copiando estrutura para tabela labbd2.carrinho_compras
CREATE TABLE IF NOT EXISTS `carrinho_compras` (
  ...
  KEY `user_id` (`user_id`),
  KEY `prod_id` (`prod_id`),
  CONSTRAINT `carrinho_compras_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`user_id`),
  CONSTRAINT `carrinho_compras_ibfk_2` FOREIGN KEY (`prod_id`) REFERENCES `produtos` (`prod_id`),
  CONSTRAINT `carrinho_compras_chk_1` CHECK ((`quantidade` > 0))
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Copiando dados para a tabela labbd2.carrinho_compras: ~0 rows (aproximadamente)
DELETE FROM `carrinho_compras`;
INSERT INTO `carrinho_compras` (`carrinho_id`, `user_id`, `prod_id`, `quantidade`, `data_adicao`) VALUES
	(61, 1, 1, 1, '2025-03-12 23:53:07'),
	(62, 2, 2, 1, '2025-03-12 23:53:07'),
	(63, 3, 3, 1, '2025-03-12 23:53:07'),
	(64, 4, 4, 1, '2025-03-12 23:53:07'),
	(65, 5, 5, 1, '2025-03-12 23:53:07'),
	(66, 6, 6, 1, '2025-03-12 23:53:07'),
	(67, 7, 7, 1, '2025-03-12 23:53:07'),
	(68, 8, 8, 1, '2025-03-12 23:53:07'),
	(69, 9, 9, 1, '2025-03-12 23:53:07'),
	(70, 10, 10, 1, '2025-03-12 23:53:07'),
	(71, 11, 11, 1, '2025-03-12 23:53:07'),
	(72, 12, 12, 1, '2025-03-12 23:53:07'),
	(73, 13, 13, 1, '2025-03-12 23:53:07'),
	(74, 12, 14, 1, '2025-03-12 23:53:07'),
	(75, 11, 15, 1, '2025-03-12 23:53:07'),
	(76, 10, 16, 1, '2025-03-12 23:53:07'),
	(77, 9, 17, 1, '2025-03-12 23:53:07'),
	(78, 8, 18, 1, '2025-03-12 23:53:07'),
	(79, 7, 19, 1, '2025-03-12 23:53:07'),
	(80, 6, 20, 1, '2025-03-12 23:53:07');
